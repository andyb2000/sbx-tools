...
$dorsync=`/usr/bin/rsync -avzxH -e ssh /tmp/song-copy/* root@geostat.thebmwz3.co.uk:/media/ABDS-music/00s/ 2>&1`;
$dochmod=`/usr/bin/ssh root@geostat.thebmwz3.co.uk "chmod 777 /media/ABDS-music/00s/*"`;
