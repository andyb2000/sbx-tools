...
//	echo "test: ".$out_value['Title']." <BR>\n";
	if ($out_value['Catalogue'] == "70" || $out_value['Catalogue'] == "243") {
...
$dorsync=`/usr/bin/rsync -avzxH -e ssh /tmp/song-copy/* root@geostat.thebmwz3.co.uk:/media/ABDS-music/Latest-RHPOOL/ 2>&1`;
$dochmod=`/usr/bin/ssh root@geostat.thebmwz3.co.uk "chmod 777 /media/ABDS-music/Latest-RHPOOL/*"`;
