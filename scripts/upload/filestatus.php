...
$tempFolder = "/var/www/sbschedule/scripts/upload/tempfiles";       //Make sure that this is the same as in upload.cgi.
$moveToFolder = "/var/www/sbschedule/scripts/upload/uploadedfiles"; //Where the files will be moved upon upload, leave blank if you want it to be the same as $tempFolder.
$bad_files = array('exe', 'php', 'php3', 'php4', 'ph3', 'ph4', 'perl', 'cgi', 'bin', 'scr', 'bat', 'pif', 'aps', 'ssi', 'swf', 'js', 'ogg', 'wav');

// End Configurable variables

error_reporting(E_ERROR | E_WARNING | E_PARSE);
require('/var/www/sbschedule/scripts/upload/JSON.php');
